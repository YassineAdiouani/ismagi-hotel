                    ...
                    <div class="modal-body">
                        <form id="addReservationForm" method="POST" action="{{ route('reservations.store') }}">
                            ...
                            <div class="form-group d-flex flex-column w-100">
                                ...
                                <select id="client_id" name="client_id" class="form-control select2-show-search select2-dropdown" required>
                ...
                if ($(this).parsley().isValid()) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            showCustomToast("The client was added successfully!", 'Notification', 4000);
                            var clientsCounter = $('.clients_counter');
                            if (clientsCounter.length) {
                                var currentCount = parseInt(clientsCounter.html(), 10); // Get current count and parse as integer
                ...
                if ($(this).parsley().isValid()) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $('#addRoomForm')[0].reset();
                            showCustomToast("The room was added successfully!", 'Notification', 4000);
